...
let searchImg = document.querySelector('#magnifyingGlass');

searchImg.addEventListener('click', search);
...
function search() {
    let recipeQuery = document.querySelector('#searchBar').value;
    ...
    // clears out previous recipes
    recipeContainer.innerHTML = '';
    // shows all items that match the search
...
function recipeTemplate(recipe) {
    ...
    <article class="recipe-card">
        ...
        <div class="recipeDescription">
            ...
            <p class="recipeInfo">${recipe.description}</p>
        </div>
    </article>
    `
}
